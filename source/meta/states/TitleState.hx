...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(prompted == false && ClientPrefs.checkForUpdates != 0) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/x8c8r/FNF-Tweenly-Public/main/VERSION.txt");
			...
			http.onData = function (data:String)
			{
				...
				if(updateVersion != curVersion) {
					trace('NEW TWEEN EEEEEEEEEEEYIKES!!!!');
					mustUpdate = true;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.visible = true;
				case 16:
					addMoreText('TWEENLY!!!!'); // credTextShit.text += '\nFunkin';

...
class FunkinHScript extends FunkinScript
{
	...
	public function new(parsed:Expr, ?name:String = "Script", ?additionalVars:Map<String, Any>)
	{
		...
		set("setGameOverVid", function(gameOverVid:String) {
			if (gameOverVid != null) PlayState.gameOverVid = gameOverVid;
			trace("dawg what hte fuck");
		});
		...
		set("VideoGameOverSubstate", meta.states.substate.VideoGameOverSubstate);

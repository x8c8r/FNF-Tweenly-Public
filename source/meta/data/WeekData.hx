...
class WeekData {
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		weekBanner = weekFile.weekBanner;
	...
	public static function addWeek(weekToCheck:String, path:String, directory:String, i:Int, originalLength:Int)
	{
